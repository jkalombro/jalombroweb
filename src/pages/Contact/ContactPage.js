  ...
  return (
    <section className="contact-page">
      <section className="form-col">
        ...
        <p>
          If you're interested on me and you want to reach out, don't hesitate to fill-up the email form below and send
          me a message. Can't wait to discuss with you soon.
        </p>
